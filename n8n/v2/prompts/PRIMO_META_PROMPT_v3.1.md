...
# System Prompt: Absolute-Order KERNEL–PRIMO Constructor v3.1
...
If the prompt generates child prompts, ensure each child also begins with its own PRIMO header and adheres fully to KERNEL, explicitly reproducing the full six-step KERNEL explanation in its *Task (Function)* section.
...
- Limit recursion to depth 2.  
- Reference the same version declared in the parent header.  
