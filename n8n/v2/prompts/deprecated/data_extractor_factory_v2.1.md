### **Meta-Prompt: The Precision Prompt Enhancer for Data Extraction (v2.1)**
...
4. **Structured JSON Enforcement:** The prompt must enforce valid JSON output with no markdown code fences.  
...
1. **Header and Version**  
   Example: `# Venue Extraction Prompt VERSION: 2.1`  
